...
####IMPORTANT####
Before building/running these demos, you MUST replace the bogus...
   * M2X key in m2xclient.js with your own master key . (search for 'new M2X') 
   * Google Map key in locdata_map.js with your own key from here: https://developers.google.com/maps/documentation/javascript/tutorial#api_key
